        ...
        <div className="container relative grid items-center gap-12 py-20 lg:grid-cols-12 lg:py-32">
          <div className="lg:col-span-7">
            ...
            <div className="mt-9 flex flex-wrap gap-3 animate-fade-up animate-fade-up-3">
              <Link href={`/${locale}/kontak`} className="btn-primary h-12 px-6 text-sm">
                {dict.home.primaryCta}
                <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </Link>
              <Link href={`/${locale}/layanan`} className="btn-outline h-12 px-6 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-slate-900">
                        {dict.home.assuranceTitle}
                      </p>
                      <p className="mt-0.5 text-xs text-slate-500">
                        {dict.home.assuranceBody}
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="border-t border-slate-100 bg-white py-20 sm:py-24">
        <div className="container">
          <header className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-pretty text-slate-600">{dict.home.whySubheading}</p>
          </header>
            ...
            {dict.home.whyItems.map((it, i) => {
              ...
              return (
                ...
                >
                  <div
                    aria-hidden="true"
                    className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-brand-50 opacity-60 blur-2xl transition-opacity group-hover:opacity-100"
                  />
                  <div
        ...
        <div className="container relative">
          <header className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-xl">
              <span className="eyebrow">{dict.home.servicesEyebrow}</span>
              <h2 className="mt-4 font-display text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                {dict.home.servicesHeading}
              </h2>
              <p className="mt-3 text-pretty text-slate-600">
                {dict.home.servicesSubheading}
              </p>
            </div>
            <Link
              href={`/${locale}/layanan`}
      ...
      {articles.length > 0 && (
        <section className="border-t border-slate-100 bg-slate-50/60 py-20 sm:py-24">
          <div className="container">
            <header className="flex flex-wrap items-end justify-between gap-6">
              <div className="max-w-xl">
                <span className="eyebrow">{dict.home.articlesEyebrow}</span>
                <h2 className="mt-4 font-display text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
